...
robin = SongBird.new(:omnivore, 'sing', 'chirp chirrr chirp chirp chirrrr')
  ...
  # Further Exploration
  # In its current implementation, SongBird#initialize is entirely useless, as
  # the @song instance variable is never used.
...
class BankAccount
  ...
  def withdraw(amount)
    if valid_transaction?(self.balance - amount)
